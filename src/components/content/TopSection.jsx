      ...
      <div className={css.desktopFlexWrapper}>
        <div className={css.desktopFlexItem}>
          ...
          <p>
            ...
            region, or remote CET, for <span className={css.highlight}>junior-level</span> roles or
            internships starting from <span className={css.highlight}>August 2021.</span>
          </p>
          <p>
