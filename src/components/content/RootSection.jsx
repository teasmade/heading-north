          ...
          {translate ? (
            <>
              ...
              <p className={css.highlight}>
                Je suis passé au développement web en 2020, après avoir travaillé dans la vente, les
                réservations et la gestion de l'expérience client dans le secteur du tourisme
                spécialisé.
              </p>
