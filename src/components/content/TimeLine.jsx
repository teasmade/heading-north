    ...
    <div className={css.timeline}>
      ...
      <VerticalTimeline className={css.timeLineTrunk} animate={false} layout='1-column-right'>
        ...
        >
          ...
          <p>
            Full time training in front and back end web development using React.js, Node.js, MySQL
            and Express.
          </p>
          <p>
        ...
        >
          ...
          <p>
            Application to be delivered July 2021: a system automating product ticketing processes,
            based on dynamic price and stock data, for a chain of 7 specialist sports shops.
          </p>
          <p>
            Working in 1 week sprints, we will develop our own back-end, API and front-end, usinng
        ...
        >
          ...
          <p>
            We used React alongside Leaflet for dynamic map data display. We exceeded the project
            brief in the time allocated, adding authentication and user data storage using Firebase.
          </p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
